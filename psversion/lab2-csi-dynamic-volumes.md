...
kubectl describe pod storage-demo-pod-v2 | Select-String -Pattern "Mounts:" -Context 0,20
```
...
kubectl get pods -n kube-system | Select-String -Pattern "csi"
...
3. **Volume Expansion Failed**
   ...
   kubectl get storageclass <storage-class-name> -o yaml | Select-String -Pattern "allowVolumeExpansion"
